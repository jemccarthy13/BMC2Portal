...
export class AircraftIntent {
    ...
    private tasking: Tasking|undefined = undefined
    
    updateIntent(newIntent: Partial<IntentParams>): void {
        if (newIntent.desiredAlt===0 || newIntent.desiredSpeed===0){
            console.warn("Setting intended speed or alt to 0 will not result in a change.")
        }
        ...
        this.tasking = newIntent.tasking || this.tasking
    }    
