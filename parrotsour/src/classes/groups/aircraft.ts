...
import { DataTrail, SensorType } from "classes/groups/datatrail"
import { GroupParams } from "classes/groups/group"
import { IDMatrix } from "classes/groups/id"
import { AircraftIntent, IntentParams } from "classes/groups/intent"
...
export class Aircraft {
     ...
     */
     private _getCenterOfMass( ctx?:CanvasRenderingContext2D, dataStyle?: SensorType): Point {
    ...
    */
    ...
    turnToTarget(): void {
        if(!this.intent.atFinalDestination()){
            ...
            this.intent.setDesiredHeading(this.getCenterOfMass().getBR(tgtPos).bearingNum)
        }
