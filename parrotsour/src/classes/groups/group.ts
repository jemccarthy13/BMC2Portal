...
import { ACType, Aircraft } from "classes/groups/aircraft";
import { IDMatrix } from "classes/groups/id";
import { IntentParams } from "classes/groups/intent";

// Functions
import { trackDirFromHdg } from "utils/mathutilities"
import { headingToRadians, PIXELS_TO_NM, randomNumber } from "utils/psmath";
...
export class AircraftGroup extends Array<Aircraft> {
    ...
    constructor(p?: Partial<GroupParams>){
        ...
        console.warn("Fix isCapping (group/aircraft capping logic is broken)")
    }
