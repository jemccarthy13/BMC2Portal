...
export class Braaseye {
    ...
    */
    draw(
        ...
        braaFirst: boolean,
        offsetX = 0, offsetY = 0): void {
    
        if (braaFirst){
            this.braa.draw(ctx, this.drawLoc.x + 25+offsetX, this.drawLoc.y + offsetY, "blue", showMeasurements)
            this.bull.draw(ctx, this.drawLoc.x + 25 + offsetX, this.drawLoc.y + 11 + offsetY, "black", showMeasurements)
        } else {
            this.bull.draw(ctx, this.drawLoc.x + 25 + offsetX, this.drawLoc.y + offsetY, "black", showMeasurements)
            this.braa.draw(ctx, this.drawLoc.x + 25 + offsetX, this.drawLoc.y + 11 + offsetY, "blue", showMeasurements)
        }
    }
}