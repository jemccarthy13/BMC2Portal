...
function ChangeLog(): JSX.Element {
  return (
    <div>
      ...
      Features
      <li>
        Finished conversion to typescript - also React Component library for
        varied use(s)
      </li>
      <li>Fixed small issue in package comm (labeling/anchoring)</li>
      <li>
        Implemented radar/arrow toggle (make it look like radar returns instead
        of arrows)
      </li>
      <li>
        Migrated procedural implementation -- working on further development
      </li>
      --------------------------------------- <br />
      ...
      <li>
        {" "}
        &quot;Hard Mode&quot;: random track direction and assess for
        echelon/weighted{" "}
      </li>
      ...
      <li>
        {" "}
        Initial Red air basic maneuvers (picks new heading at predetermined
        range from blue){" "}
      </li>
      Patches:
