...
export function SpeechTextControls(props: SpeechTextProps):ReactElement {
    ...
    const preProcess = (transcript:string) => {
        ...
        tmpAnswer = tmpAnswer.replaceAll("golf", "gulf").replaceAll("proseed","proceed").replaceAll("precede","proceed")
        ...
        const re = new RegExp(/^([A-Za-z])[A-Za-z]*([A-Za-z]) *([0-9])[0-9]*([0-9])/)
    ...
    return (
        ...
        {transcript && <div className="microphone-result-container">
